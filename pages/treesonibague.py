...
from components.graphs.graphs import graphtrees
from components.graphs.graphs2 import graphtrees2
from components.graphs.graphs3 import commontrees
from components.graphs.graphs4 import commontrees2
from components.sampledf.model_data import df_comunas,df_ibague

register_page(__name__, path="/arbolesenibague")
        ...
        dbc.Row([
            dbc.Col([
                 dbc.NavLink((
                    ...
                    html.Img(src='/assets/images/ocobo.jpeg',height="400px"),
            ...
            dbc.Col([
                 dbc.NavLink((
                    ...
                    html.Img(src='/assets/images/palma.jpeg',height="400px")
                    ,
            ...
            dbc.Col([
               ...
               dbc.NavLink((
                    ...
                    html.Img(src='/assets/images/pera.jpg',height="400px")
                    ,
        ...
        dbc.Row([
            ...
            dbc.Col([
                dbc.NavLink((
                    ...
                    html.Img(src='/assets/images/banco.jpeg',height="400px")
                    ,
